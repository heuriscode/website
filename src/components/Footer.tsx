      ...
      <Container>
        <div className="flex items-center justify-between py-16">
          ...
          <nav className="text-sm" aria-label="quick links">
            <ul className="-my-1 flex justify-center space-x-6">
              ...
              <li>
                <Link href="/#team">
                  <a className="rounded-lg px-2 py-1 text-slate-700 hover:bg-slate-100 hover:text-slate-900">Team</a>
                </Link>
              </li>
              <li>
                <Link href="/#blog">
                  <a className="rounded-lg px-2 py-1 text-slate-700 hover:bg-slate-100 hover:text-slate-900">Blog</a>
                </Link>
              </li>
            </ul>
          </nav>
        ...
        <div className="flex flex-col items-center border-t border-slate-400/10 py-10 sm:flex-row-reverse sm:justify-between">
          <div className="flex space-x-6">
            <Link href="https://github.com/heuriscode" target="_blank">
              <a className="group">
